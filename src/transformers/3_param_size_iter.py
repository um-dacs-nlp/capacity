...
RESULTS_FILE = (
    "../../../data/out_metrics/results_{timestamp}_paramsize_{config_index}.pkl"
)
LOSSES_FILE = (
    "../../../data/out_metrics/losses_{timestamp}_paramsize_{config_index}.pkl"
)
MODELS_FILE = "../../../data/out_models/models_{timestamp}_paramsize_{config_index}.pkl"
...
configurations = list(
    itertools.product(n_values, activation_functions, n_layers_values, d_model_values)
)

# Save configurations to a file
config_filename = "../../../data/configs/experiment_param_size_configs.pkl"
...
for config_index in range(start_index, min(end_index, len(configurations))):
    n, activation_fn_name, n_layers, d_model = configurations[config_index]
